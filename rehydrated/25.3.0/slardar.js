	...
	setTimeout(() => {
		...
		const K = function(e) {
			function o() {
				...
				const r = e.apply(undefined, a([], L(n), false));
				o.returns = r;
				o.resolved = true;
		...
		var Q = function() {
			...
			return Object.defineProperty({
				then(r) {
					function e() {
						return n.apply(undefined, a([], L(t.map(n => n.returns)), false));
					}
					...
					var n = K(function() {
						...
						return i ? o : (i = true, o = r.apply(undefined, a([], L(n), false)));
					});
		...
		const an = function(i, u, c) {
			return function() {
				...
				if (!i) return j;
				const r = i[u];
				const e = c.apply(undefined, a([ r ], L(n), false));
				let o = e;
		...
		const hn = function(n, t, r, e) {
			...
			try {
				const o = n.apply(undefined, a([], L(e), false));
				return o && o(t, r) || [];
			} catch (n) {
				return [];
			}
		...
		function gn(n, t, r) {
			...
			return e = !(t = undefined === t ? false : t) ? b(e) ? e.split('?')[0] : e : e;
		}
		...
		function En(n, t) {
			...
			} else if (c(n)) { r.push.apply(r, a([], L(n), false)) } else { r.push.apply(r, a([], L(Object.entries(n)), false)) }
			return O(r);
		}
		...
		function Cn(i, u, c) {
			...
			return function() {
				...
				return ((n = o[0])?.method || (n = o[1])?.method || 'GET') !== 'GET' ? i.apply(undefined, a([], L(o), false)) : new Promise((t, r) => {
					const e = f += 2;
					u(e, Date.now());
					i.apply(undefined, a([], L(o), false)).then(n => {
						c(e);
						t(n);
					}, n => {
						c(e, n);
		...
		const Gt = (n($t, Ut = It), $t.prototype._shouldSend = function(n) {
			...
			return n.name === jn || n.name === Bn ? function(n) {
				...
				if (c(n = t.whitelistUrls) && n.length > 0) {
					...
					return Boolean(e && e.test(r.event.ax_url));
				}
		...
		function Zt() {
			...
			var r = n[2];
			const i = Gn.apply(undefined, a([], L(n), false));
			if (r) return i;
		...
		if (!(!rr || (or = rr[It]) !== null && undefined !== or && or.r)) {
			...
			(or = function() {
				...
				try {
					return er.apply(undefined, a([], L(n), false));
				} catch (n) {}
			}).version = '1.1.61';
			or.r = 1;
			rr[It] = or;
